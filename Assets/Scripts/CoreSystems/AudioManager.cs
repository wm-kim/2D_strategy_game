...
namespace Minimax
{
    public class AudioManager : MonoBehaviour
    {
        ...
        [SerializeField] [Range(0, 1)] private float m_masterVolume = 1f;
        ...
        // 현재 재생중인 모든 오디오 소스
        private List<AudioSource> m_activeAudioSources = new List<AudioSource>(); 
        ...
        {
            AudioSource audioSource = m_activeAudioSources.Find(source => source.clip.name == audio.ToString());
