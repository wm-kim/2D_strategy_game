...
namespace Minimax.AddressableSystem
{
    public class DownloadEvents
    {
        ...
        {
            SystemInitializedListener?.Invoke();
        }
        ...
        public void NotifyCatalogUpdated()
        {
            CatalogUpdatedListener?.Invoke();
        }
        ...
        public void NotifySizeDownloaded(long size)
        {
            SizeDownloadedListener?.Invoke(size);
        }
        ...
        public void NotifyDownloadProgress(DownloadProgressStatus status)
        {
            DownloadProgressListener?.Invoke(status);
        }
        ...
        public void NotifyDownloadFinished(bool isSuccess)
        {
            DownloadFinished?.Invoke(isSuccess);
        }
    }
}