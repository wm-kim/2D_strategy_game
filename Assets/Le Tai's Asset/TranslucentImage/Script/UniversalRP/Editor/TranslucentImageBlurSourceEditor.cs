    ...
    public override void OnInspectorGUI()
    {
        ...
        if (feature.rendererType == RendererType.Renderer2D)
        {
            ...
            if (
                ...
                EditorGUILayout.HelpBox("The 2D Renderer is sometimes buggy with custom renderer features at the moment. If you're encountering problems, check if the built-in \"Full Screen Pass Renderer Feature\" is functioning correctly in the same setup. If it does not, Translucent Image is unlikely to be able to work either.", MessageType.Warning, true);
            else
